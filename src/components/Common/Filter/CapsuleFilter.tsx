...
const CapsuleFilter = ({ categories, onClick, onClickReset }: Props) => {
  return (
    <div css={filterCss.wrap}>
      {categories.some((category) => category.active) && (
        <button css={filterCss.reset} onClick={onClickReset}>
      ...
      {categories.map((category) => (
        <div
          css={[filterCss.capsule, category.active && filterCss.activeCapsule]}
          key={category.code}
